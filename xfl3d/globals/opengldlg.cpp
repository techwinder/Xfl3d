    ...
    QVBoxLayout *pMainLayout = new QVBoxLayout;
    {
        ...
        m_pButtonBox = new QDialogButtonBox(QDialogButtonBox::Close, this);
        {
            ...
            QMenu *pViewSelMenu = new QMenu;
            {
                ...
                pLorenzAct->setData(      4);
                pLorenz2Act->setData(     5);
                pAttractorsAct->setData(  6);
                pBoidsAct->setData(       7);
                pBoids2Act->setData(      8);
...
QOpenGLWidget *OpenGlDlg::getView(int iView)
{
    switch(iView)
    {
        ...
        case 4:  return new gl3dLorenz;
        case 5:  return new gl3dLorenz2;
        case 6:  return new gl3dAttractors;
        case 7:  return new gl3dBoids;
        case 8:  return new gl3dBoids2;
