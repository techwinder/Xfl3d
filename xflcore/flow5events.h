...
const QEvent::Type LBM_FORCE_EVENT           = static_cast<QEvent::Type>(QEvent::User + 117);
const QEvent::Type LBM_UPDATE_EVENT          = static_cast<QEvent::Type>(QEvent::User + 118);
const QEvent::Type LBM_END_EVENT             = static_cast<QEvent::Type>(QEvent::User + 119);
