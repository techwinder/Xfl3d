...
{
    for(int l=0; l<m_CtrlPoint.size(); l++)
    {
...
void Frame::insertPoint(int n)
{
    ...
    else if(n>0 && n<m_CtrlPoint.size()-1)
    {
...
*/
void Frame::copyPoints(QVector<Vector3d> const &PointList)
{
...
{
    double l=0.0;
    for(int i=1; i<m_CtrlPoint.count(); i++)
    {
...
{
    if(i<0 || i>m_CtrlPoint.count()-1) return 0.0;
