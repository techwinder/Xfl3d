...
void GraphOptions::setDefaults(bool bDark)
{
    ...
    if(bDark)
    {
        ...
        s_theBorderStyle.m_Color = QColor(200,200,200);

        QColor axiscolor(200,200,200);
        s_XAxis.setColour(axiscolor);
        s_YAxis[0].setColour(axiscolor);
        s_YAxis[1].setColour(axiscolor);
    ...
    else
    {
        ...
        s_theBorderStyle.m_Color = QColor(55,55,55);
...
void GraphOptions::makeWidgets()
{
    ...
    m_pGroupBox.push_back(new QGroupBox("Fonts"));
    {
        ...
        m_pGroupBox.last()->setLayout(pFontButtonsLayout);
    }
    ...
    m_pGroupBox.push_back(new QGroupBox("BackGround"));
    {
        ...
        m_pGroupBox.last()->setLayout(pBackDataLayout);
    }
    ...
    m_pGroupBox.push_back(new QGroupBox("Padding"));
    {
        ...
        m_pGroupBox.last()->setLayout(pPaddingLayout);
    }
    ...
    m_pGroupBox.push_back(new QGroupBox("Axes and grids"));
    {
        ...
        m_pGroupBox.last()->setLayout(pAxisDataLayout);
    }
    ...
    m_pGroupBox.push_back(new QGroupBox("Curves"));
    {
        ...
        m_pGroupBox.last()->setLayout(pDefaultLineLayout);
    }
...
void GraphOptions::initWidget()
{
    ...
    LineStyle ls = LineStyle(true, Line::SOLID, Curve::defaultLineWidth(), QColor(255,0,0), Line::NOSYMBOL);
    ...
    m_pcbLine->lineDelegate()->setLineColor(ls.m_Color);
...
{
    LineStyle ls(true, Line::SOLID, index+1, Qt::red, Line::NOSYMBOL);
    m_pcbLine->setLine(ls);
...
void GraphOptions::loadSettings(QSettings &settings)
{
    settings.beginGroup("GraphOptions");
    {
        ...
        if(settings.contains("BorderStyle")) s_theBorderStyle.loadSettings(settings, "BorderStyle");
...
void GraphOptions::saveSettings(QSettings &settings)
{
    settings.beginGroup("GraphOptions");
    {
        ...
        s_theBorderStyle.saveSettings(settings, "BorderStyle");
