...
class Graph
{
    ...
    public:
        ...
        void setAxisColor(QColor crColor) {m_XAxis.setColour(crColor); m_YAxis[0].setColour(crColor); m_YAxis[1].setColour(crColor);}
        ...
        void setBorderColor(QColor crBorder) {m_theBorderStyle.m_Color = crBorder;}
        ...
        QColor axisColor(AXIS::enumAxis axis) const ;
        ...
        QColor borderColor()                const {return m_theBorderStyle.m_Color;}
